...
#-----------------------------------------------------------------------
# Bourne shell environment setup script for Geant4 10.3.2
#
...
if [ -z "$BASH_VERSION" ]; then
  ...
  geant4make_root="/software/geant4-10.03.p02-el7-x86_64/share/Geant4-10.3.2/geant4make"
else
...
export G4LIB="`cd $geant4make_root/../../../lib64/Geant4-10.3.2 > /dev/null ; pwd`"
...
# User's G4WORKDIR
#
export G4WORKDIR=$(pwd)/geant4_workdir
...
export G4LEDATA="`cd $geant4make_root/../data/G4EMLOW6.50 > /dev/null ; pwd`"
export G4LEVELGAMMADATA="`cd $geant4make_root/../data/PhotonEvaporation4.3.2 > /dev/null ; pwd`"
export G4RADIOACTIVEDATA="`cd $geant4make_root/../data/RadioactiveDecay5.1.1 > /dev/null ; pwd`"
...
export G4ENSDFSTATEDATA="`cd $geant4make_root/../data/G4ENSDFSTATE2.1 > /dev/null ; pwd`"
